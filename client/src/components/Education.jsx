      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8 relative z-10">
        ...
        <div className="relative space-y-12 w-full max-w-5xl mx-auto">
          ...
          {education.map((edu, idx) => (
            ...
            >
              {/* Timeline Dot */}
              <div className="absolute w-4 h-4 rounded-full left-0 md:left-[28px] top-1 md:top-2 bg-gradient-to-r from-emerald-400 to-teal-500 shadow-[0_0_15px_rgba(52,211,153,0.8)] z-10 transition-transform duration-300 group-hover:scale-125" />
              ...
              <div className="md:col-span-9 bg-white/5 backdrop-blur-md p-8 md:p-10 rounded-3xl border border-white/10 shadow-[0_8px_32px_rgba(0,0,0,0.3)] transition-all duration-300 group-hover:border-emerald-500/30 group-hover:bg-white/10 group-hover:-translate-y-1">
                <h3 className="text-2xl md:text-3xl text-white font-bold mb-2 tracking-tight drop-shadow-sm">{edu.degree}</h3>
                <h4 className="text-transparent bg-clip-text bg-gradient-to-r from-emerald-400 to-teal-400 font-medium mb-6 text-sm uppercase tracking-widest font-mono">{edu.school}</h4>
                <p className="text-slate-300 leading-relaxed text-sm md:text-lg font-light">{edu.details}</p>
              </div>
            </motion.div>
          ))}
        </div>
