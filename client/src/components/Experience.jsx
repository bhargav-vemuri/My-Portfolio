    ...
    <section id="experience" className="relative w-full py-32 bg-transparent border-t border-cream/5">
      <div className="max-w-7xl mx-auto px-4 md:px-8 relative z-10">
        <div className="flex flex-col md:flex-row md:items-end justify-between border-b border-cream/10 pb-8 mb-16">
          <div>
            <p className="text-slate-blue tracking-[0.2em] uppercase text-xs font-mono font-semibold mb-4 drop-shadow-[0_0_10px_rgba(96,165,250,0.8)]">Experience</p>
            <h2 className="font-sans font-bold text-4xl md:text-5xl tracking-tight text-cream drop-shadow-lg">Professional Journey</h2>
          </div>
        </div>
